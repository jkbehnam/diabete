...
public class graph_Badazsobh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_badazsobh);

        overridePendingTransition(R.anim.anim_notmain2, R.anim.anim_notmain1);

        toolbar = (Toolbar) findViewById(R.id.badsobhane);
        ...
        txttoolbar.setText("بعد از صبحانه");
        ...
        final GraphView graph = (GraphView) findViewById(R.id.graph_badsobhane);



        graph.setTitle("نمودار قند بعد از صبحانه");

        SQLiteDatabase db = openOrCreateDatabase(User_Path + "profile_info.db",
                SQLiteDatabase.CREATE_IF_NECESSARY, null);
        final Cursor cr = db.rawQuery("select * from glucose_tb  where when_d ='"+1+"' order by glu_y , glu_m , glu_d ", null);
