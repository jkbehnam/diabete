...
public class other_CustomListAdapter extends BaseAdapter {

    int z = 0;
    private Context context1;
    private ArrayList<class_others_day> data;

    public Resources res;


    public other_CustomListAdapter(Context context, ArrayList<class_others_day> objects, int a) {


        context1 = context;
       data = new ArrayList<class_others_day>();
        data=objects;
