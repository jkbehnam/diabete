...
public class graph_3midnight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_3midnight);

        overridePendingTransition(R.anim.anim_notmain2, R.anim.anim_notmain1);

        toolbar = (Toolbar) findViewById(R.id.midnight);
        ...
        txttoolbar.setText("قند نیمه شب");
        ...
        final GraphView graph = (GraphView) findViewById(R.id.gragh_midnight);


        graph.setTitle("نمودار قند نیمه شب");

        SQLiteDatabase db = openOrCreateDatabase(User_Path + "profile_info.db",
                SQLiteDatabase.CREATE_IF_NECESSARY, null);
        final Cursor cr = db.rawQuery("select * from glucose_tb  where when_d ='"+6+"' order by glu_y , glu_m , glu_d ", null);
