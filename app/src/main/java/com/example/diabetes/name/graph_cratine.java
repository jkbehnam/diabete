...
public class graph_cratine extends BaseActivity2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cratine);


        toolbar = (Toolbar) findViewById(R.id.cratineappbar);
        setSupportActionBar(toolbar);
        TextView txttoolbar = (TextView) findViewById(R.id.txttoolbar);
        txttoolbar.setText("نمودار کراتین خون");
       ...
       final GraphView graph = (GraphView) findViewById(R.id.cratinegraph);
        ...
        if (cr.getCount() != 0) {
            ...
            do {
                ...
                sb[i] = dtStart;
                i++;
                series2.appendData(s, true, 100);
                series3.appendData(s, true, 100);
